...
<body class="text-center">
  ...
  <main class="form-signin w-100 m-auto">
    <form action="../server/save_user.php" method="POST">
      ...
      <button class="w-100 btn btn-lg btn-primary" type="submit" name="sumbit">Зарегистрироваться</button>
      <div style="margin-top: 20px; ">
        <a href="../index.php" style="text-decoration: none;">Войти в систему</a>
      </div>
